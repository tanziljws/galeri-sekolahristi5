...
<head>
    ...
    @endif
    <title>Registrasi User - SMK Negeri 4 Kota Bogor</title>
            ...
            <div class="register-body">
                ...
                <form action="{{ route('user.register') }}" method="POST">
                    ...
                    <div class="text-center">
                        <p class="mb-2">Sudah punya akun? <a href="{{ route('user.login.form') }}" class="text-decoration-none">Login di sini</a></p>
