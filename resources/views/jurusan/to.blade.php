    ...
    <style>
        ...
        * {
        ...
        .hero-jurusan .hero-bg {
            ...
            background-image: url('{{ asset('images/jurusan/smkn4-building-right.JPG') }}');
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="mb-4">
                        <img src="{{ asset('images/jurusan/to-logo.jpg') }}" alt="Logo TO" class="jurusan-logo-large">
                    </div>
                    <h1 class="hero-title">TO</h1>
                    <p class="hero-subtitle">Teknik Otomotif</p>
                    <p class="lead">Jurusan yang mempersiapkan siswa menjadi ahli otomotif dan teknisi kendaraan</p>
    ...
    <section class="py-5" style="background: white;">
        <div class="container">
            <h2 class="section-title">Galeri Kegiatan TO</h2>
            <p class="text-center text-muted mb-5">Dokumentasi kegiatan pembelajaran dan praktik di bengkel TO</p>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Admin dapat menambahkan foto kegiatan TO melalui panel admin</p>
                </div>
            @endif
    ...
    <section class="py-5">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-6">
                    <h2 class="section-title text-start">Tentang Jurusan TO</h2>
                    <p class="lead mb-4">
                        Jurusan Teknik Otomotif (TO) adalah program keahlian yang fokus pada sistem kendaraan bermotor, perawatan, dan perbaikan mesin kendaraan.
                    </p>
                    <p class="mb-4">
                        Siswa akan mempelajari berbagai aspek otomotif, mulai dari mesin, sistem kelistrikan, sistem rem, sistem kemudi, hingga teknologi kendaraan modern. Jurusan ini sangat penting dalam industri otomotif yang terus berkembang dengan teknologi terbaru.
                    </p>
                ...
                <div class="col-lg-6">
                    <div class="info-card">
                        ...
                        <div class="skill-item">
                            <h6 class="mb-2">Automotive Technician</h6>
                            <p class="mb-0 text-muted">Ahli dalam perbaikan dan perawatan kendaraan</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Engine Specialist</h6>
                            <p class="mb-0 text-muted">Spesialis mesin dan sistem propulsi</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Electrical System Expert</h6>
                            <p class="mb-0 text-muted">Ahli sistem kelistrikan kendaraan</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Service Advisor</h6>
                            <p class="mb-0 text-muted">Konsultan layanan otomotif</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Mesin Otomotif</h5>
                        <p class="text-muted text-center">Konstruksi dan prinsip kerja mesin</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Sistem Kelistrikan</h5>
                        <p class="text-muted text-center">Kelistrikan body dan mesin kendaraan</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Sistem Transmisi</h5>
                        <p class="text-muted text-center">Gearbox, kopling, dan sistem penggerak</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Sistem Rem</h5>
                        <p class="text-muted text-center">Sistem pengereman dan ABS</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Perawatan Kendaraan</h5>
                        <p class="text-muted text-center">Service berkala dan troubleshooting</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Diagnosis Komputer</h5>
                        <p class="text-muted text-center">Scanner dan sistem OBD</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Teknisi otomotif</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Spesialis mesin</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        <i class="fas fa-bolt fa-3x text-primary mb-3"></i>
                        <h5>Electrical Expert</h5>
                        <p class="text-muted">Ahli kelistrikan</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Konsultan layanan</p>
                    </div>
                </div>
            </div>
        </div>
