    ...
    <style>
        ...
        * {
        ...
        .hero-jurusan .hero-bg {
            position: absolute;
            inset: 0;
            background-image: url('{{ asset('images/jurusan/tjkt-bg.jpg.JPG') }}');
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="mb-4">
                        <img src="{{ asset('images/jurusan/tjkt-logo.jpg') }}" alt="Logo TJKT" class="jurusan-logo-large">
                    </div>
                    <h1 class="hero-title">TJKT</h1>
                    <p class="hero-subtitle">Teknik Jaringan Komputer dan Telekomunikasi</p>
                    <p class="lead">Jurusan yang mempersiapkan siswa menjadi ahli jaringan dan telekomunikasi di era digital</p>
    ...
    <!-- Galeri Kegiatan TJKT -->
    <section class="py-5" style="background: white;">
        <div class="container">
            <h2 class="section-title">Galeri Kegiatan TJKT</h2>
            <p class="text-center text-muted mb-5">Dokumentasi kegiatan pembelajaran dan praktik di laboratorium TJKT</p>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Admin dapat menambahkan foto kegiatan TJKT melalui panel admin</p>
                </div>
            @endif
    ...
    <section class="py-5">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-6">
                    <h2 class="section-title text-start">Tentang Jurusan TJKT</h2>
                    <p class="lead mb-4">
                        Jurusan Teknik Jaringan Komputer dan Telekomunikasi (TJKT) adalah program keahlian yang fokus pada pengelolaan dan pengembangan jaringan komputer serta sistem komunikasi.
                    </p>
                    <p class="mb-4">
                        Siswa akan mempelajari berbagai aspek jaringan komputer, mulai dari perancangan, implementasi, hingga maintenance jaringan. Jurusan ini sangat penting dalam mendukung infrastruktur teknologi informasi yang menjadi tulang punggung digitalisasi.
                    </p>
                ...
                <div class="col-lg-6">
                    <div class="info-card">
                        ...
                        <div class="skill-item">
                            <h6 class="mb-2">Network Administrator</h6>
                            <p class="mb-0 text-muted">Mengelola dan memelihara jaringan komputer</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Network Engineer</h6>
                            <p class="mb-0 text-muted">Merancang dan membangun infrastruktur jaringan</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">System Administrator</h6>
                            <p class="mb-0 text-muted">Mengelola sistem operasi dan server</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Telecommunication Engineer</h6>
                            <p class="mb-0 text-muted">Ahli dalam sistem telekomunikasi</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Jaringan Dasar</h5>
                        <p class="text-muted text-center">Konsep dasar jaringan komputer dan protokol</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Administrasi Sistem</h5>
                        <p class="text-muted text-center">Linux, Windows Server, dan sistem operasi</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Keamanan Jaringan</h5>
                        <p class="text-muted text-center">Cybersecurity dan network security</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Jaringan Nirkabel</h5>
                        <p class="text-muted text-center">WiFi, Bluetooth, dan teknologi wireless</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Telekomunikasi</h5>
                        <p class="text-muted text-center">Sistem komunikasi dan telephony</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Cloud Computing</h5>
                        <p class="text-muted text-center">Teknologi cloud dan virtualisasi</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Mengelola infrastruktur jaringan</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Mengelola sistem dan server</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Keamanan jaringan dan cybersecurity</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        <i class="fas fa-phone fa-3x text-primary mb-3"></i>
                        <h5>Telecom Engineer</h5>
                        <p class="text-muted">Ahli telekomunikasi</p>
                    </div>
                </div>
            </div>
        </div>
