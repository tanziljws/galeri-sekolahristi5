    ...
    <style>
        ...
        * {
        ...
        .hero-jurusan .hero-bg {
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #1e40af 100%);
            background-image: url('{{ asset('images/jurusan/tpfl-bg.jpg.JPG.JPG') }}');
        ...
        .activity-image {
            position: relative;
            overflow: hidden;
            height: 220px; /* seragamkan tinggi */
        }

        .activity-image img {
            width: 100%;
            height: 100%;
            object-fit: cover; /* seragam tanpa mengubah file asli */
            transition: transform 0.3s ease;
        }
        ...
        .activity-info h6 { margin-bottom: 6px; font-weight: 600; }
        .activity-info p  { margin: 0; font-size: 0.9rem; opacity: 0.9; }
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="mb-4">
                        <img src="{{ asset('images/jurusan/tp-logo.jpg') }}" alt="Logo TPFL" class="jurusan-logo-large">
                    </div>
                    <h1 class="hero-title">TPFL</h1>
                    <p class="hero-subtitle">Teknik Pengelasan Fabrikasi Logam</p>
                    <p class="lead">Jurusan yang mempersiapkan siswa menjadi ahli pengelasan dan fabrikasi logam</p>
    ...
    <!-- Galeri Kegiatan TPFL -->
    <section class="py-5" style="background: white;">
        <div class="container">
            <h2 class="section-title">Galeri Kegiatan TPFL</h2>
            <p class="text-center text-muted mb-5">Dokumentasi kegiatan pembelajaran dan praktik pengelasan</p>
                        ...
                        <div class="activity-card">
                            <div class="activity-image">
                                @if($activity->fotos->count() > 0)
                                    ...
                                    @endphp
                                    <img src="{{ $imageUrl }}" alt="{{ $activity->post->judul ?? $activity->judul }}" class="img-fluid">
                                @else
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Admin dapat menambahkan foto kegiatan TPFL melalui panel admin</p>
                </div>
            @endif
    ...
    <section class="py-5">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-6">
                    <h2 class="section-title text-start">Tentang Jurusan TPFL</h2>
                    <p class="lead mb-4">
                        Jurusan Teknik Pengelasan Fabrikasi Logam (TPFL) adalah program keahlian yang fokus pada proses pembuatan dan pengolahan logam menjadi produk yang berguna.
                    </p>
                    <p class="mb-4">
                        Siswa akan mempelajari berbagai teknik pengelasan, fabrikasi logam, dan proses manufaktur. Jurusan ini sangat penting dalam industri manufaktur, konstruksi, dan otomotif yang membutuhkan keahlian dalam pengolahan logam.
                    </p>
                ...
                <div class="col-lg-6">
                    <div class="info-card">
                        ...
                        <div class="skill-item">
                            <h6 class="mb-2">Welder</h6>
                            <p class="mb-0 text-muted">Ahli dalam berbagai teknik pengelasan</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Metal Fabricator</h6>
                            <p class="mb-0 text-muted">Membuat dan merakit produk logam</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Quality Inspector</h6>
                            <p class="mb-0 text-muted">Memeriksa kualitas hasil pengelasan</p>
                        </div>
                        <div class="skill-item">
                            <h6 class="mb-2">Production Supervisor</h6>
                            <p class="mb-0 text-muted">Mengawasi proses produksi logam</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5" style="background: white;">
        <div class="container">
            <h2 class="section-title">Mata Pelajaran Kejuruan</h2>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Teknik Pengelasan</h5>
                        <p class="text-muted text-center">SMAW, GMAW, GTAW, dan teknik pengelasan lainnya</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Fabrikasi Logam</h5>
                        <p class="text-muted text-center">Pemotongan, pembentukan, dan perakitan logam</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Gambar Teknik</h5>
                        <p class="text-muted text-center">Membaca dan membuat gambar teknik</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Pengujian Material</h5>
                        <p class="text-muted text-center">Pengujian kekuatan dan kualitas logam</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">Perawatan Peralatan</h5>
                        <p class="text-muted text-center">Maintenance mesin dan peralatan</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="info-card">
                        ...
                        <h5 class="text-center mb-3">K3</h5>
                        <p class="text-muted text-center">Keselamatan dan kesehatan kerja</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <h5>Welder</h5>
                        <p class="text-muted">Pengelasan berbagai jenis logam</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        <i class="fas fa-cogs fa-3x text-primary mb-3"></i>
                        <h5>Metal Fabricator</h5>
                        <p class="text-muted">Pembuatan produk logam</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Pemeriksaan kualitas produk</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="info-card text-center">
                        ...
                        <p class="text-muted">Pengawas produksi</p>
                    </div>
                </div>
            </div>
        </div>
