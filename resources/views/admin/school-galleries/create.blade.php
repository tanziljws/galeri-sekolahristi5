...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Foto Galeri Sekolah Baru</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Foto Galeri Sekolah</h6>
            <small class="text-muted">Foto ini akan muncul di halaman utama "Galeri Agenda Sekolah"</small>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.school-galleries.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save fa-sm"></i> Simpan Foto
                    </button>
                </div>
            </form>
        </div>
    ...
    <div class="alert alert-warning">
        ...
        <ul class="mb-0">
            <li>Foto yang ditambahkan di sini akan muncul di halaman utama "Galeri Agenda Sekolah"</li>
